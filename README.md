...
- [the-nexim/nanolib](https://github.com/the-nexim/nanolib) ([@nexim/financial-calculate@1.0.8](https://github.com/the-nexim/nanolib/releases/tag/%40nexim/financial-calculate%401.0.8), 5 days ago) - This repository contains numerous small utility packages. These packages serve various useful purposes and are written in nano ESModule.
- [the-nexim/internal-toolkit](https://github.com/the-nexim/internal-toolkit) ([@nexim/api-connect@1.0.2](https://github.com/the-nexim/internal-toolkit/releases/tag/%40nexim/api-connect%401.0.2), 4 weeks ago) - 
