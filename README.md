...
- [lerna-lite/lerna-lite](https://github.com/lerna-lite/lerna-lite) - Subset of Lerna in a smaller &amp; more modular project. Helps manage and publish multiple packages in a monorepo/workspace structure (2 days ago)
...
- [lerna-lite/lerna-lite](https://github.com/lerna-lite/lerna-lite) ([v3.5.2](https://github.com/lerna-lite/lerna-lite/releases/tag/v3.5.2), 2 days ago) - Subset of Lerna in a smaller &amp; more modular project. Helps manage and publish multiple packages in a monorepo/workspace structure
...
- [fix(version): update get last commit hash info regex to support all timezone](https://github.com/lerna-lite/lerna-lite/pull/875) on [lerna-lite/lerna-lite](https://github.com/lerna-lite/lerna-lite) (3 days ago)
