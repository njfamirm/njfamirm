...
- [lit/lit](https://github.com/lit/lit) ([@lit-labs/ssr@3.0.1](https://github.com/lit/lit/releases/tag/%40lit-labs/ssr%403.0.1), today) - Lit is a simple library for building fast, lightweight web components.
...
- [refactor: inline export/import type](https://github.com/AliMD/alwatr/pull/670) on [AliMD/alwatr](https://github.com/AliMD/alwatr) (1 day ago)
- [feat(salavat-api): new api nanoservice](https://github.com/AliMD/alwatr/pull/669) on [AliMD/alwatr](https://github.com/AliMD/alwatr) (1 day ago)
- [feat(day-countdown-api): new api nanoservice](https://github.com/njfamirm/alwatr/pull/2) on [njfamirm/alwatr](https://github.com/njfamirm/alwatr) (2 days ago)
- [feat(dcd-notifier): new api microservice](https://github.com/njfamirm/alwatr/pull/1) on [njfamirm/alwatr](https://github.com/njfamirm/alwatr) (2 days ago)
- [feat(soffit-pwa): deploy](https://github.com/AliMD/alwatr/pull/659) on [AliMD/alwatr](https://github.com/AliMD/alwatr) (3 days ago)
...
- [lovell/sharp](https://github.com/lovell/sharp) - High performance Node.js image processing, the fastest module to resize JPEG, PNG, WebP, AVIF and TIFF images. Uses the libvips library. (2 days ago)
- [KnorpelSenf/typegram](https://github.com/KnorpelSenf/typegram) - TypeScript types for the entire Telegram Bot API (6 days ago)
- [nitreojs/puregram](https://github.com/nitreojs/puregram) - powerful and modern telegram bot api sdk for node.js and typescript 😁 (6 days ago)
