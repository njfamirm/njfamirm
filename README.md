...
- [decaporg/decap-cms](https://github.com/decaporg/decap-cms) ([decap-cms@3.1.4](https://github.com/decaporg/decap-cms/releases/tag/decap-cms%403.1.4), 1 day ago) - A Git-based CMS for Static Site Generators
...
- [explosion/spaCy](https://github.com/explosion/spaCy) - 💫 Industrial-strength Natural Language Processing (NLP) in Python (4 days ago)
- [mozilla/DeepSpeech](https://github.com/mozilla/DeepSpeech) - DeepSpeech is an open source embedded (offline, on-device) speech-to-text engine which can run in real time on devices ranging from a Raspberry Pi 4 to high power GPU servers. (4 days ago)
