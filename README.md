...
- [njfamirm/training](https://github.com/njfamirm/training) - repo contain my trainig exmaple. (5 days ago)
...
- [decaporg/decap-cms](https://github.com/decaporg/decap-cms) ([decap-cms@3.1.0-beta.1](https://github.com/decaporg/decap-cms/releases/tag/decap-cms%403.1.0-beta.1), 5 days ago) - A Git-based CMS for Static Site Generators
...
- [Alwatr/icon](https://github.com/Alwatr/icon) ([@alwatr/icon-set-extra@0.4.0](https://github.com/Alwatr/icon/releases/tag/%40alwatr/icon-set-extra%400.4.0), 6 days ago) - Alwatr Icon Collections

### Recent Pull Requests

- [feat(nginx): implement redirect](https://github.com/Alwatr/nginx/pull/7) on [Alwatr/nginx](https://github.com/Alwatr/nginx) (2 days ago)
- [[WIP] feat: setup script, use link for files](https://github.com/Alwatr/1bash/pull/9) on [Alwatr/1bash](https://github.com/Alwatr/1bash) (2 days ago)
...
- [json5/json5](https://github.com/json5/json5) - JSON5 — JSON for Humans (2 days ago)
...
- [navanshu/postcss-variable-compress](https://github.com/navanshu/postcss-variable-compress) - Minifies / Obscures CSS variable names (5 days ago)
