...
- [lit/lit](https://github.com/lit/lit) ([@lit/localize-tools@0.6.8](https://github.com/lit/lit/releases/tag/%40lit/localize-tools%400.6.8), 4 days ago) - Lit is a simple library for building fast, lightweight web components.
...
- [feat(com): cdn](https://github.com/AliMD/alwatr/pull/983) on [AliMD/alwatr](https://github.com/AliMD/alwatr) (1 day ago)
- [feat(button): use content property and move to manager](https://github.com/AliMD/alwatr/pull/978) on [AliMD/alwatr](https://github.com/AliMD/alwatr) (2 days ago)
...
- [evanw/thumbhash](https://github.com/evanw/thumbhash) - A very compact representation of an image placeholder (1 day ago)
- [nasa/apod-api](https://github.com/nasa/apod-api) - Astronomy Picture of the Day API service (5 days ago)
- [google/tachometer](https://github.com/google/tachometer) - Statistically rigorous benchmark runner for the web (6 days ago)
