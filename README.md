...
- [Alwatr/nanolib](https://github.com/Alwatr/nanolib) ([@alwatr/dedupe@1.0.0](https://github.com/Alwatr/nanolib/releases/tag/%40alwatr/dedupe%401.0.0), 2 days ago) - This repository contains numerous small utility packages. These packages serve various useful purposes and are written in nano ESModule without any dependencies.
- [Alwatr/store](https://github.com/Alwatr/store) ([v5.0.0-beta](https://github.com/Alwatr/store/releases/tag/v5.0.0-beta), 5 days ago) - Alwatr Storage: Extremely fast and compact JSON-based database that operates in memory, includes a JSON file backup, and serve over the highly accelerated Nginx.
...
- [feat(dedupe): new package](https://github.com/Alwatr/nanolib/pull/26) on [Alwatr/nanolib](https://github.com/Alwatr/nanolib) (2 days ago)
- [feat: change devMode env name on logger ,support bun and isCli platform-info](https://github.com/Alwatr/nanolib/pull/25) on [Alwatr/nanolib](https://github.com/Alwatr/nanolib) (2 days ago)
- [feat: new async-quque and faltomise package](https://github.com/Alwatr/nanolib/pull/24) on [Alwatr/nanolib](https://github.com/Alwatr/nanolib) (2 days ago)
- [feat(engine): use alwatr exit hook](https://github.com/Alwatr/store/pull/186) on [Alwatr/store](https://github.com/Alwatr/store) (2 days ago)
- [fix(exit-hook): typo function name](https://github.com/Alwatr/nanolib/pull/23) on [Alwatr/nanolib](https://github.com/Alwatr/nanolib) (2 days ago)
...
- [openai/openai-node](https://github.com/openai/openai-node) - The official Node.js / Typescript library for the OpenAI API (3 days ago)
