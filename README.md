...
- [njfamirm/mind-swap](https://github.com/njfamirm/mind-swap) - An AI chatbot designed to save notes, tasks, and ideas from your mind to your account. (3 days ago)
...
- [Alwatr/store](https://github.com/Alwatr/store) ([v6.0.2](https://github.com/Alwatr/store/releases/tag/v6.0.2), 1 day ago) - Alwatr Storage: Extremely fast and compact JSON-based database that operates in memory, includes a JSON file backup, and serve over the highly accelerated Nginx.
...
- [njfamirm/mind-swap](https://github.com/njfamirm/mind-swap) ([v0.1.1](https://github.com/njfamirm/mind-swap/releases/tag/v0.1.1), 3 days ago) - An AI chatbot designed to save notes, tasks, and ideas from your mind to your account.
- [Alwatr/fract](https://github.com/Alwatr/fract) ([@alwatr/style@2.2.0](https://github.com/Alwatr/fract/releases/tag/%40alwatr/style%402.2.0), 3 days ago) - Alwatr Fract: an application development framework
- [Alwatr/pmpa](https://github.com/Alwatr/pmpa) ([v1.2.1](https://github.com/Alwatr/pmpa/releases/tag/v1.2.1), 3 days ago) - Progressive Multi Page (Web) Application.

### Recent Pull Requests

- [feat(app): naked layout](https://github.com/Alwatr/pmpa/pull/75) on [Alwatr/pmpa](https://github.com/Alwatr/pmpa) (3 days ago)
- [feat(types): new package](https://github.com/Alwatr/pmpa/pull/74) on [Alwatr/pmpa](https://github.com/Alwatr/pmpa) (3 days ago)
- [feat(ci/publish-container): get siteUrl as params](https://github.com/Alwatr/pmpa/pull/73) on [Alwatr/pmpa](https://github.com/Alwatr/pmpa) (3 days ago)
- [feat(ci/publish-container): get siteUrl as params](https://github.com/Alwatr/pmpa/pull/72) on [Alwatr/pmpa](https://github.com/Alwatr/pmpa) (3 days ago)
...
- [mde/ejs](https://github.com/mde/ejs) - Embedded JavaScript templates -- http://ejs.co (5 days ago)
