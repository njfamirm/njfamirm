...
- [decaporg/decap-cms](https://github.com/decaporg/decap-cms) ([decap-cms@3.1.5](https://github.com/decaporg/decap-cms/releases/tag/decap-cms%403.1.5), 1 day ago) - A Git-based CMS for Static Site Generators
- [Alwatr/store](https://github.com/Alwatr/store) ([v6.0.3](https://github.com/Alwatr/store/releases/tag/v6.0.3), 1 day ago) - Alwatr Storage: Extremely fast and compact JSON-based database that operates in memory, includes a JSON file backup, and serve over the highly accelerated Nginx.
...
- [Croluy/DoggoReportBot](https://github.com/Croluy/DoggoReportBot) - Telegram bot that allows people to get in touch with channel admins indirectly. (4 days ago)
