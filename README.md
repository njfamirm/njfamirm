...
- [decaporg/decap-cms](https://github.com/decaporg/decap-cms) ([decap-cms@3.2.1](https://github.com/decaporg/decap-cms/releases/tag/decap-cms%403.2.1), 5 days ago) - A Git-based CMS for Static Site Generators
...
- [google/incremental-dom](https://github.com/google/incremental-dom) - An in-place DOM diffing library (3 days ago)
- [continuedev/continue](https://github.com/continuedev/continue) - ⏩ Continue is the leading open-source AI code assistant. You can connect any models and any context to build custom autocomplete and chat experiences inside VS Code and JetBrains (6 days ago)
