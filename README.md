...
- [Alwatr/soffit-order-admin](https://github.com/Alwatr/soffit-order-admin) - Soffit Order admin panel. (3 days ago)
...
- [Alwatr/nanolib](https://github.com/Alwatr/nanolib) ([@alwatr/local-storage@1.0.0](https://github.com/Alwatr/nanolib/releases/tag/%40alwatr/local-storage%401.0.0), 3 days ago) - This repository contains numerous small utility packages. These packages serve various useful purposes and are written in nano ESModule without any dependencies.
- [Alwatr/store](https://github.com/Alwatr/store) ([v6.0.0-alpha.0](https://github.com/Alwatr/store/releases/tag/v6.0.0-alpha.0), 4 days ago) - Alwatr Storage: Extremely fast and compact JSON-based database that operates in memory, includes a JSON file backup, and serve over the highly accelerated Nginx.
...
- [njfamirm/lorem-ipsum.ir](https://github.com/njfamirm/lorem-ipsum.ir) ([v1.0.0](https://github.com/njfamirm/lorem-ipsum.ir/releases/tag/v1.0.0), 6 days ago) - Fast lorem ipsum generator static website ✅

### Recent Pull Requests

- [feat(bot): base telegram bot template](https://github.com/Alwatr/pmpa/pull/61) on [Alwatr/pmpa](https://github.com/Alwatr/pmpa) (2 days ago)
- [feat(polyfill-has-own): new package](https://github.com/Alwatr/nanolib/pull/38) on [Alwatr/nanolib](https://github.com/Alwatr/nanolib) (3 days ago)
- [chore: change project name from pmpa to new](https://github.com/Alwatr/soffit-order-admin/pull/5) on [Alwatr/soffit-order-admin](https://github.com/Alwatr/soffit-order-admin) (3 days ago)
...
- [kilimchoi/engineering-blogs](https://github.com/kilimchoi/engineering-blogs) - A curated list of engineering blogs (1 day ago)
